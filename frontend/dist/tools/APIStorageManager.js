...
function buildFinishPayload(scoreP1, scoreP2, match) {
...
export async function updateInfo(password, toUpdate, newValue) {
...
export async function addNewFriend(friendName) {
...
export async function asGuest(asPlayer2 = false) {
...
export async function createMatch(playerType, name, password) {
    if (playerType == "registered" && !name && !password)
        return null;
...
export async function updateMatchResult(scoreP1, scoreP2, match) {
...
export async function launchTournament(nbPlayers) {
    ...
    return data.Tournament[0];
}
export async function joinTournamentAsLogged(tournamentId, name, password) {
...
export async function joinTournamentAsGuest(tournamentId) {
...
export async function startTournament(tournamentId) {
    ...
    console.log("data tournament as Type: ", data.tournament);
    return data.tournament;
}
export async function nextTournamentMatch(scoreP1, scoreP2, match) {

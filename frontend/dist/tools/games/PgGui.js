import { AdvancedDynamicTexture, Button, Control, Rectangle, InputText, TextBlock, ScrollViewer } from "@babylonjs/gui";
import { navigate } from "../../router";
import { createMatch, updateMatchResult, launchTournament, joinTournamentAsGuest, joinTournamentAsLogged, startTournament, nextTournamentMatch } from "../APIStorageManager";
export default class PgGui {
    ...
    initTournament() {
        ...
        const switchToPlayersSetting = (nbOfPlayers) => {
            ...
            startButton.onPointerClickObservable.add(() => {
                ...
                startTournament(this.currentTournament.id).then((tournament) => {
                    ...
                    if (this.currentMatch.player1.type === "ia" && this.currentMatch.player2.type === "ia")
                        ...
                        this.startedType = { type: "local" };
                    this.match.visibility(true, this.currentMatch.player1.name ? this.currentMatch.player1.name : "normalAI", this.currentMatch.player2.name ? this.currentMatch.player2.name : "normalAI");
                });
            });
    ...
    initMatch() {
        ...
        const playButton = Button.CreateSimpleButton("playButton", "Play");
        {
            ...
            playButton.onPointerClickObservable.add(() => {
                // Start match
                if (this.currentMatch == null && this.startedType?.type !== "watchAI")
                    return;
                this.match.visibility(false);
                this.started = true;
            });
        ...
        const visibility = (visible, player1, player2) => {
    ...
    initResult() {
        ...
        const nextMatchButton = Button.CreateSimpleButton("nextMatchButton", "Next Match");
        {
            ...
            nextMatchButton.onPointerClickObservable.add(() => {
                ...
                if (this.currentTournament == null || !this.currentTournament.matches?.length)
                    return;
    ...
    initWatchAI() {
        ...
        const startButton = Button.CreateSimpleButton("startButton", "Start");
        {
            ...
            startButton.onPointerClickObservable.add(() => {
                ...
                if (this.watchAI.left.selectedAIMode === "" || this.watchAI.right.selectedAIMode === "")
                    return;
                this.watchAI.visibility(false);
    ...
    initLogin() {
        ...
        const visibility = (visible, prevUI) => {
